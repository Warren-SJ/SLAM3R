# --------------------------------------------------------
# This file includes or adapts code from third-party projects and the SLAM3R
# research implementation. Upstream code is provided under CC BY-NC-SA 4.0.
# Adaptations here are © 2025–present Warren Samuelson Jayakumar and are
# distributed under the same CC BY-NC-SA 4.0.

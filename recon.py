...
by Yuzheng Liu, Siyan Dong, Shuzhe Wang, Yingda Yin, Yanchao Yang, Qingnan Fan, Baoquan Chen.

Original upstream implementations are © 2024–present Naver Corporation and/or the original authors,
licensed under Creative Commons Attribution-NonCommercial-ShareAlike 4.0 (CC BY-NC-SA 4.0).
This adaptation is © 2025–present Warren Samuelson Jayakumar and is distributed under the same
CC BY-NC-SA 4.0 license (non-commercial use only). See THIRD_PARTY_NOTICES.md for details.
